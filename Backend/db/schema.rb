...
ActiveRecord::Schema[7.1].define(version: 2025_07_15_213044) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.index ["created_at"], name: "index_orders_on_created_at", order: :desc
    t.index ["customer_email"], name: "index_orders_on_customer_email"
    t.index ["customer_phone"], name: "index_orders_on_customer_phone"
    t.index ["status", "created_at"], name: "index_orders_on_status_and_created_at", order: { created_at: :desc }
